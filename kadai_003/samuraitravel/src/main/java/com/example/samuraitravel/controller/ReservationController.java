...
public class ReservationController {
	...
	public String index(@AuthenticationPrincipal UserDetailsImp1 userDetailsImp1,@PageableDefault(page=0,size=10,sort="id",direction = Direction.ASC)Pageable pageable,Model model)
	{
		User user=userDetailsImp1.getUser();
	...
	public String confirm(@PathVariable(name="id")Integer id,@ModelAttribute ReservationInputForm reservationInputForm,
			@AuthenticationPrincipal UserDetailsImp1 userDetailsImp1,HttpServletRequest httpServletRequest,Model model)
	{
        ...
        Integer amount=reservationService.calculationAmount(checkinDate, checkoutDate, price);
		...
		model.addAttribute("sessionId", sessionId);
		 System.out.println("ReservationController：reservations/confirmへ遷移");
