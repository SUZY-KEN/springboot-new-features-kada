...
public class UserController{
	...
	private final UserService userService;
	 ...
	 @GetMapping
     public String index(@AuthenticationPrincipal UserDetailsImp1 userDetailsImpl, Model model) {         
	 ...
	 @GetMapping("edit")
	 public String edit(@AuthenticationPrincipal UserDetailsImp1 userDetailsImp1,Model model) {
	 ...
	 {
		 if(userService.isEmailRegistered(userEditForm.getEmail())&&userService.isEmailChanged(userEditForm)){
